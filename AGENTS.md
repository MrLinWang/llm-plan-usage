...
# Test
python -m pytest tests/ -v       # 145 tests, ~12s (pbkdf2 password hashing dominates)
...
- **Run**: `python -m pytest tests/ -v` — 145 tests, ~12s, no network (auth tests pay real pbkdf2 600k-iteration hashing per user creation/login).
